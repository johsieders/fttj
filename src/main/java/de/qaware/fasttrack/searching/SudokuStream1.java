...
public class SudokuStream1 implements SearchProblemStream<SudokuStream1.State, Step> {
    int[][] grid = new int[9][9];

    public SudokuStream1(String input) {
        if (input != null) {
            int counter = 0;
    ...
    public Stream<Step> getSteps() {
        return Stream.generate(new getStepsStream1());
    }
    ...
    public class State {
        ...
        public String toString() {
            return SudokuStream1.this.toString();
        }
    }

    public class getStepsStream1 implements Supplier<Step> {
        private int iMem;
        private int jMem;
        private int valueMem;

        public getStepsStream1() {
            this.iMem = 0;
            this.jMem = 0;
            this.valueMem = 0;
        }
